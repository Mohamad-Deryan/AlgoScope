const algorithms = [
  ...
  },
  {
    ...
    name: "Merge Sort",
    category: "Sorting",
    description: "Visualize divide-and-conquer sorting by splitting and merging arrays.",
  ...
  },
  {
    ...
    name: "Quick Sort",
    category: "Sorting",
    description: "Visualize partition-based sorting using a pivot element.",
  ...
  },
  {
    ...
    name: "DFS",
    category: "Graphs",
    description: "Explore graph traversal using depth-first exploration and a stack-based approach.",
    complexity: "O(V + E)",
    visualizerPath: "/graphs",
  },
  {
